...
Hooks.on("ready", async () => {
  ...
  let characterFolder = starforgedOracles.children.find(children => children.displayName === "Characters");
  let nameCharactersIndex = characterFolder.children.indexOf(characterFolder.children.find(children => children.displayName === "Name"));
  ...
  let starshipsMissionIndex = starshipsFolder.children.indexOf(starshipsFolder.children.find(children => children.displayName === "Mission"));

  // TODO: Vaults interios and sanctum folders
